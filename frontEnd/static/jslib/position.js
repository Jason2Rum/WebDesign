...
function createPos(){
	...
	$(c_card).append('<h5 class="card-title">任职族谱</h5>');
...
function load_relation_graph2(num, graphId){
...
//		d3.json("json/relation3.json", function(error, graph) {
    d3.json("http://118.24.43.47:8089/staff-map?graphId="+graphId, function(error, graph) {
