...
function secondNavAction(first_nav_order, sub_nav_order) {
    ...
    if (first_nav_order == 1 && sub_nav_order == 1) {
        ...
        "<p>1、注册资本并不需要一次缴清</p>" +
        "<p>我国目前实行注册资本认缴制，认缴制的意思就是：注册资本不用在一开始就全部缴纳完成，而是只要在承诺的时限内(一般为10-20年)缴完即可，这极大的降低了公司注册时的资金压力。 [1]  </p>" +
        "<p>2、公司注册资本写多少，要参考所在行业资质要求</p>" +
        "<p>例如，互联网公司申请ICP经营许可证时，ICP经营许可证要求公司注册资本在100万以上；天猫对大多数类目的入驻商家标准也是100万以上。其他需要资质/资格的，要参照本行业一般的做法。</p>" +
        "<p>3、注册资本越大，承担的风险/责任就越大</p>" +
        ...
        "<p>4、创始合伙人的得权期、退出机制、回购权一个完整的企业股权结构，除了合理的股份分配外，还要有科学的管理体系，即提前约定好股权的得权、退出和回购机制，避免日后纠纷。</p>" +
        "<p>5、提前留一定的期权池</p>" +
        ...
        "<p>备注：以上材料为纳税人第一次购票应准备手续，一般纳税人第一次购票，除做以上准备外，还应准备以下材料：电脑培训的上岗证原件，税控系统IC卡，购票前先自己电脑零抄税一次（在抄税前，应先输入企业的基本信息），并打印零抄税单。如税务部门有新要求或新规定企业应以税务部门为准！</p>" +
        ...
        content_title_list = [""];
        content_list = ["<p>申请网站ICP许可证的，应当符合《中华人民共和国电信条例》第十三条的规定和下列条件：</p>" +
        ...
        content_title_list = [""];
        content_list = ["<p>1.投融资办理企业向审批机关提交董事会决议和董事长签署的申请书等文件。</p>" +
        "　　</p>" +
        "　　<p>2.审批机关在接到投融资办理申请文件后，以书面形式作出是否同意的答复。</p>" +
        "　　</p>" +
        "　　<p>3.审批机关进行投融资申请审核。</p>" +
        "　　</p>" +
        "　　<p>4.经审批机关审核同意后，投融资办理企业按照变更登记的有关规定，向工商行政机关申请变更登记。</p>" +
        "　　</p>" +
        "　　<p>5.投融资办理完成。</p>"];
    }
